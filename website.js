    ...
    function playChatSound() {
        try {
            ...
            function triggerChime() {
                ...
                gain1.gain.linearRampToValueAtTime(0.12, t + 0.015);
                ...
                gain2.gain.linearRampToValueAtTime(0.14, t + 0.095);
            ...
            if (ctx.state === "suspended") {
                ...
                // Browser autoplay fallback: play on first user interaction
                var played = false;
